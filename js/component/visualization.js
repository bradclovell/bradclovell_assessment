...
/**
 * Calls function to submit some interesting FDA API queries and create relevant graphings of the returned data.
 *
 * @param {HTMLElement} parent
 */
component.visualization.prototype.decorate_data = function(parent) {

  // Creates all three graphings for the given search term.
